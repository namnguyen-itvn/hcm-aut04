...
import com.example.test.core.helper.AiNHReadConfigPropertyFile;
...
public class KbbBaseTest {
    ...
    public String baseUrl = AiNHReadConfigPropertyFile.getPropertyValue("url");
    public String browser = AiNHReadConfigPropertyFile.getPropertyValue("browser");
