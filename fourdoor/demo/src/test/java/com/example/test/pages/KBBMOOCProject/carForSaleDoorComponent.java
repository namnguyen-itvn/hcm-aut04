...
public class carForSaleDoorComponent extends KbbBasePage{
    ...
    public boolean chekDoorsFilterAfterClick() {
        WebElement doorsFilterAfterExtending = keyword.findWebElementByXpath("//span[@data-cmp='filterTitle']//span[text()='Doors']/parent::span/parent::div/following-sibling::div");
