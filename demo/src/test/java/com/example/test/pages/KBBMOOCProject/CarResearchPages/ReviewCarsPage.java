...
public class ReviewCarsPage extends KbbBasePage {
    ...
    public void firstOther() throws InterruptedException {
        WebElement btnOther = keyword.findWebElementByXpath("//span[text()='See More Compact Sedans']");
        keyword.scrollAndWaitToClick(btnOther);
    }
}
