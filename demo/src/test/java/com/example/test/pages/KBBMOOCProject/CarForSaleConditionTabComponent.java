...
public class CarForSaleConditionTabComponent extends KbbPageBase{
    ...
    public boolean isTheConditionFilterShouldBeDisplayedCorrectWhenUserClickOnIt(){
        ...
        if (isElementDisplayed(optionNew) == true && 
        isElementDisplayed(optionManufacturerCertified) == true && 
        isElementDisplayed(optionThirdPartyCertified) == true && 
        isElementDisplayed(optionUsed)== true)
        {
            return true;
        }
        else return false;
