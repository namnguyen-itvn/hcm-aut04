...
public class CarDeliveryPageTest extends KbbBaseTest {
    ...
    public  void verifyCarModelForSaleResultDisplayed(String zip, String url ,String title,String delivery) throws InterruptedException{
        ...
        Assert.assertTrue(carDeliveryPage.checkTitleComponent(title));
