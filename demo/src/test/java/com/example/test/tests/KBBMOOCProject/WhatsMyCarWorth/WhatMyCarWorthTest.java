...
public class WhatMyCarWorthTest extends KbbBaseTest {
    ...
    public void VerifyMileageValueChangeSuccessfulWhenUserEditMileageValue(String vin,String email,String mileage ,String zipcode,String mileagee) throws InterruptedException{
        ...
        detailVehicleValuePage.actionEditValueMileage(mileagee);
        detailVehicleValuePage.actionClickOnSavebutton();

        //
        Assert.assertTrue(detailVehicleValuePage.actionCompareResultAfterUserEditValueMileagesuccessful());
    ...
    public void VerifyTheVINCodeIsDisplayedCorrectlyAsTheUserEntered(String vin,String email,String mileage ,String zipcode,String mileagee) throws InterruptedException{
        WhatMyCarWorthPage whatMyCarWorthPage = new WhatMyCarWorthPage(driver);
        whatMyCarWorthPage.actionGoToCategoryStylePage(vin,email);
        ...
        Assert.assertTrue(detailVehicleValuePage.actionCompareValueVinINVehicleValueDetailWithValueVINEnteredVinValue());
