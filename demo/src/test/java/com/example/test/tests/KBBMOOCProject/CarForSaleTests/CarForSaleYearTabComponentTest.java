...
public class CarForSaleYearTabComponentTest extends KbbBaseTest{
    ...
    @Test(testName = "verify Yeartab Title After User select Maximun Year and Minimum Year Success")
    public void verifyYearTitlePageWhenUserSelectMaximumandMiniMumYearSuccess() throws InterruptedException{
        CarForSaleYearTabComponent carForSaleYearTabComponent = new CarForSaleYearTabComponent(driver);
