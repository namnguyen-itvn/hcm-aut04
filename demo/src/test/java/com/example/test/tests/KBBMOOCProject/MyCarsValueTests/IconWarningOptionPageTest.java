...
import com.example.test.pages.KBBMOOCProject.MyCarsValuePage.OptionPageSelectCPMP3Component;
...
public class IconWarningOptionPageTest  extends KbbBaseTest{
    ...
    @Test(testName = "Verify displayed warning icon beside CD/MP3(Single Disc) checkbox after user click CD/MP3(Multi Disc) checkbox",dataProviderClass =MileageandZipcode.class, dataProvider = "MileageandZip")
    public void verifydisplayedwarningiconandmessagebesideCDMP3SingleDisccheckboxafteruserclickCDMP3MultiDisccheckbox (String Mileage,String Zipcode, String VIN, String Email,String Category) throws InterruptedException{
        ...
        OptionPageSelectCPMP3Component selectCPMP3Component=new OptionPageSelectCPMP3Component(driver);
        selectCPMP3Component.actionSelectCPMP3();
        Assert.assertTrue(selectCPMP3Component.isselectCPMP3SingDisSelected());
