...
public class ResearchNewAndUsedCarsPageTest extends KbbBaseTest {
    ...
    @Test(testName = "Verify Select a different year in list from Year dropdown located on top of Car Name on Review Page to change to a different vehicle Page with the chosen year in Review Page",dataProviderClass =   phpAccount.class, dataProvider = "inputzipcode")
