...
import com.example.test.pages.KBBMOOCProject.MyCarsValuePage.CategoryAndStyleExtendPage;
import com.example.test.pages.KBBMOOCProject.MyCarsValuePage.CategoryAndStylePage;
import com.example.test.pages.KBBMOOCProject.MyCarsValuePage.ColorComponentInOptionsPage;
...
public class OfferOptionPageTests extends KbbBaseTest{
    ...
    public void verifyThatGetACashOfferForYourSpecificVehicleCheckboxCanBeCheckAndUncheckButGetYourTradeInPrivatePartyValuesCanNotUncheck(String vin, String email, String mileage, String zip, String automatic) throws InterruptedException {
        ...
        CategoryAndStyleExtendPage categoryAndStyleExtendPage = new CategoryAndStyleExtendPage(driver);
        categoryAndStyleExtendPage.sendKeysToZIPTextbox(zip);
        categoryAndStyleExtendPage.sendKeysToMileageTextbox(mileage);
        categoryAndStyleExtendPage.clickOnNextButton();
        OptionsPage optionsPage = new OptionsPage(driver);
        optionsPage.clickOnSelectYourOptions();
        ColorComponentInOptionsPage colorComponentInOptionsPage = new ColorComponentInOptionsPage(driver);
        colorComponentInOptionsPage.clickOnRedColor();
