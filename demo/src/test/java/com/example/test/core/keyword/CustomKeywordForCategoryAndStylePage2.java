...
public class CustomKeywordForCategoryAndStylePage2 {
    private WebDriver driver;
    private WebDriverWait wait;

    public CustomKeywordForCategoryAndStylePage2(WebDriver driver,WebDriverWait wait) {
        this.driver = driver;
        this.wait = wait;
    }
     ...
     */
    public CustomKeywordForCategoryAndStylePage2 click(WebElement element){
        Actions actions = new Actions(this.driver);
        actions.moveToElement(element).build().perform();
        waitForElementIsDisplayed(element).click();
        return new CustomKeywordForCategoryAndStylePage2(driver, wait);
    }

    public CustomKeywordForCategoryAndStylePage2 clickThenWait(WebElement btnMakeModel){
        try {
