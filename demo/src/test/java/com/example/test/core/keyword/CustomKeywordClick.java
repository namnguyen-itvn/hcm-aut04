...
public class CustomKeywordClick {
    private WebDriver driver;
    private WebDriverWait wait;

    public CustomKeywordClick(WebDriver driver, WebDriverWait wait) {
        this.driver = driver;
        this.wait = wait;
    }
     ...
     */
    public CustomKeywordClick scrollAndWaitToClick(WebElement element) throws InterruptedException {
        try {
            scrollToElemtnIntoView(element);
            ...
            element.click();
            waitForPageLoad();
            return new CustomKeywordClick(driver, wait);
        } catch (WebDriverException ex) {
     ...
     * @throws InterruptedException
     */
    public CustomKeywordClick waitToClick(WebElement element) throws InterruptedException {
        try {
